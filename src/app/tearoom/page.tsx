...
export default function TearoomPage() {
  return (
    <div className="space-y-5">
      ...
      >
        <span className="pointer-events-none absolute -right-3 -top-4 opacity-15"><Emoji char="🫖" size={128} /></span>
        ...
        <h1 className="flex items-center gap-2 text-2xl font-bold text-cocoa sm:text-3xl">
          <span className="animate-float-slow"><Emoji char="🍵" size={30} /></span> The Tearoom
        </h1>
